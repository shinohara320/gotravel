...
const Testimonials = () => {
  ...
  useEffect(() => {
    axios
      .get(import.meta.env.VITE_API_URL + '/alltestimonials')
      .then((response) => {
  ...
  return (
    <div>
      <section className="my-none dark:bg-gray-800 dark:text-gray-100">
        ...
        <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
          {isLoading ? (
            ...
            testimonials.slice(0, 4).map((testimoni) => (
              <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg" key={testimoni.id}>
                ...
                <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-400 dark:text-gray-900">
                  <img src={testimoni.image} alt="" className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full dark:bg-gray-700" />
                  <p className="text-xl font-semibold leadi">{testimoni.user}</p>
